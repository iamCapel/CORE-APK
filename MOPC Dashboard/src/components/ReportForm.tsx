...
import GpsApproval from './GpsApproval';
...
const ReportForm: React.FC<ReportFormProps> = ({
  ...
  const [ultimoGuardado, setUltimoGuardado] = useState<any>(null);

  // GPS state
  const [gpsEnabled, setGpsEnabled] = useState(parentGpsEnabled);
  const [gpsStatus, setGpsStatus] = useState('');
  const [showGpsApproval, setShowGpsApproval] = useState(false);
  ...
  const guardarIntervencion = () => {
    ...
    setUltimoGuardado(intervencion);
    limpiarFormulario();
